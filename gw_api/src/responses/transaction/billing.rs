...
mod tests {
    ...
    fn can_serialize_from_billing() {
        ...
        check_serialize_to_response(&billing, &exp, "{\"country\":\"GB\"}");
        ...
        check_serialize_to_response(&billing, &exp, 
            "{\"first_name\":\"Ben\",\"last_name\":\"Jones\",\"city\":\"Llandudno Junction\",\"country\":\"GB\"}"
        );
    }
}
